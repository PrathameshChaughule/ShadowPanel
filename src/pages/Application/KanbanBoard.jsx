    ...
    <div>
      <Navbar>
        <div className="flex flex-col gap-7 sm:p-[24px]">
          ...
          <div className="overflow-x-auto w-[95vw] mx-2 sm:mx-0 md:w-[70vw] xl:w-full">
            <div className="min-w-200 xl:w-full flex justify-around items-start gap-4">
              <div className="w-[33%] bg-white dark:bg-[#030318] rounded shadow">
                ...
                <div className="p-4.5 flex flex-col gap-5">
                  {kanbanData.todo.map((item) => (
                    <div
                      key={item.id}
                      className="border dark:border-[#011743] border-[#CED2D4] rounded px-4 py-3"
                    >
              ...
              <div className="w-[33%] bg-white dark:bg-[#030318] rounded shadow">
                ...
                <div className="p-4.5 flex flex-col gap-5">
                  {kanbanData.inprogress.map((item) => (
                    <div
                      key={item.id}
                      className="border border-[#CED2D4] dark:border-[#011743] rounded px-4 py-3"
                    >
                      <div className="flex justify-between items-center">
                        <span
                          className={`px-1.5 text-white rounded bg-${item.priorityColor}-500`}
