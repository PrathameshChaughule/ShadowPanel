    ...
    <div>
      <Navbar>
        <div className="flex w-full flex-col gap-7 sm:p-[24px]">
          ...
          <div className="w-[100%] bg-white border border-[#CED2D4] flex rounded">
            {/* left */}
            <div className="w-[24%] border-r border-[#CED2D4] p-4 px-6">
              ...
              <ul>
                <li className="flex mb-1 justify-between items-center gap-2 p-2 bg-blue-100 rounded text-blue-600 font-semibold">
                ...
                <li className="flex items-center gap-2 p-2 hover:bg-blue-100 cursor-pointer rounded hover:text-blue-600 font-semibold">
                  <FaRegStar />
                  Starred
                </li>
                <li className="flex items-center gap-2 p-2 hover:bg-blue-100 cursor-pointer rounded hover:text-blue-600 font-semibold">
            ...
            {/* right */}
            <div className="w-[80%] ">
              <div className="flex justify-between p-3 border-b border-[#CED2D4]">
                <div className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    name=""
                    ...
                    onChange={selectAll}
                  />
                  <BsArchive className="p-2.5 text-4xl rounded bg-gray-200 cursor-pointer hover:bg-gray-300" />
                  <HiOutlineTrash className="p-2.5 text-4xl rounded bg-gray-200 cursor-pointer hover:bg-gray-300" />
                  <TbMessageReport className="p-2.5 text-4xl rounded bg-gray-200 cursor-pointer hover:bg-gray-300" />
                  <BsThreeDotsVertical className="p-2.5 text-4xl rounded border border-gray-300 cursor-pointer hover:bg-gray-100" />
                </div>
              ...
              {emails.map((items) => (
                <div
                  key={items.id}
                  className="flex justify-between p-3 border-b border-[#CED2D4]"
                >
